...
var o6=_mz(z,'image',['class',10,'src',1],[],e2,t1,gg)
_(x5,o6)
_(b3,x5)
return b3
}
lY.wxXCkey=2
_2z(z,8,aZ,e,s,gg,lY,'item','__i0__','movieId')
_(cW,oX)
var f7=_n('view')
...
_(f7,c8)
_(cW,f7)
var oBB=_mz(z,'scroll-view',['class',18,'scrollX',1],[],e,s,gg)
var lCB=_v()
_(oBB,lCB)
var aDB=function(eFB,tEB,bGB,gg){
var xIB=_n('view')
_rz(z,xIB,'class',24,eFB,tEB,gg)
var oJB=_n('view')
_rz(z,oJB,'class',25,eFB,tEB,gg)
var fKB=_mz(z,'image',['class',26,'src',1],[],eFB,tEB,gg)
_(oJB,fKB)
var cLB=_n('view')
...
_(cLB,hMB)
_(oJB,cLB)
var oNB=_mz(z,'trailer-star',['bind:__l',30,'innerScore',1,'isShowInnerScore',2,'vueId',3],[],eFB,tEB,gg)
_(oJB,oNB)
_(xIB,oJB)
_(bGB,xIB)
return bGB
...
lCB.wxXCkey=4
_2z(z,22,aDB,e,s,gg,lCB,'item','__i1__','id')
_(cW,oBB)
var cOB=_n('view')
...
var h1B=_mz(z,'video',['controls',-1,'class',45,'poster',1,'src',2],[],oXB,xWB,gg)
_(fYB,h1B)
return fYB
}
bUB.wxXCkey=2
_2z(z,43,oVB,e,s,gg,bUB,'item','__i2__','id')
_(cW,eTB)
var o2B=_n('view')
_rz(z,o2B,'class',48,e,s,gg)
var c3B=_n('view')
_rz(z,c3B,'class',49,e,s,gg)
var o4B=_mz(z,'image',['class',50,'src',1],[],e,s,gg)
_(c3B,o4B)
var l5B=_n('view')
_rz(z,l5B,'class',52,e,s,gg)
var a6B=_oz(z,53,e,s,gg)
_(l5B,a6B)
_(c3B,l5B)
_(o2B,c3B)
_(cW,o2B)
...
var cDC=_n('view')
_rz(z,cDC,'class',59,xAC,o0B,gg)
var hEC=_mz(z,'image',['class',60,'src',1],[],xAC,o0B,gg)
_(cDC,hEC)
var oFC=_n('view')
_rz(z,oFC,'class',62,xAC,o0B,gg)
var cGC=_n('view')
_rz(z,cGC,'class',63,xAC,o0B,gg)
var oHC=_oz(z,64,xAC,o0B,gg)
_(cGC,oHC)
_(oFC,cGC)
var lIC=_mz(z,'trailer-star',['bind:__l',65,'innerScore',1,'isShowInnerScore',2,'vueId',3],[],xAC,o0B,gg)
_(oFC,lIC)
var aJC=_n('view')
_rz(z,aJC,'class',69,xAC,o0B,gg)
var tKC=_oz(z,70,xAC,o0B,gg)
_(aJC,tKC)
_(oFC,aJC)
var eLC=_n('view')
_rz(z,eLC,'class',71,xAC,o0B,gg)
var bMC=_oz(z,72,xAC,o0B,gg)
_(eLC,bMC)
_(oFC,eLC)
_(cDC,oFC)
var oNC=_mz(z,'view',['bindtap',73,'class',1,'data-event-opts',2,'data-index',3],[],xAC,o0B,gg)
var xOC=_mz(z,'image',['class',77,'src',1],[],xAC,o0B,gg)
_(oNC,xOC)
var oPC=_n('view')
_rz(z,oPC,'class',79,xAC,o0B,gg)
var fQC=_oz(z,80,xAC,o0B,gg)
_(oPC,fQC)
_(oNC,oPC)
var cRC=_mz(z,'view',['animation',81,'class',1],[],xAC,o0B,gg)
var hSC=_oz(z,83,xAC,o0B,gg)
_(cRC,hSC)
_(oNC,cRC)
_(cDC,oNC)
_(oBC,cDC)
...
e8B.wxXCkey=4
_2z(z,57,b9B,e,s,gg,e8B,'item','index','id')
_(cW,t7B)
_(r,cW)
return r
}
...
_(eZC,b1C)
_(tYC,eZC)
var o2C=_mz(z,'input',['bindconfirm',5,'class',1,'confirmType',2,'data-event-opts',3,'maxlength',4,'placeholder',5],[],e,s,gg)
_(tYC,o2C)
_(aXC,tYC)
var x3C=_n('view')
...
var o0C=_n('view')
_rz(z,o0C,'class',16,h7C,c6C,gg)
var lAD=_mz(z,'image',['class',17,'src',1],[],h7C,c6C,gg)
_(o0C,lAD)
_(o8C,o0C)
return o8C
}
o4C.wxXCkey=2
_2z(z,14,f5C,e,s,gg,o4C,'item','__i0__','id')
_(aXC,x3C)
_(r,aXC)
return r
}
